...
echo "mb_substr3:" . $parca . "<br/>";	// mb_substr: stringin belirtilen aralığını döndürür

//string pozisyonu
$kitap = "Web Tasarım Kılavuzu";
if (($index = mb_strpos($kitap, "ıl", 0, "UTF-8")) === false) // İlk Eleman 0
	echo "Aranan Eleman Bulunamadı" . "<br>"; // mb_strpos: stringin belirtilen karakterini döndürür 
else
	echo  $index . "<br>";
/*
